...
console.log(z.toUpperCase())                 // RAMAYAN              
console.log(z.toLowerCase())                // ramayan
console.log(z.indexOf("y"))                 // 4
console.log(z.lastIndexOf("a"))             // 5   
console.log(z.charAt(8))                    // Blank Value
console.log(z.charAt(4))                    // y
console.log(z.includes("n"))                // True
console.log(z.startsWith("r"))             // False
console.log(z.endsWith("a"))               // False

// 4. Slicing, Replacing, and Splitting 

let r = "Ravan - The King of Lanka"

console.log(r.slice(0, 3))                  // Rav
console.log(r.slice(1, 6))                 // avan 
console.log(r.substring(1, 4))            //  ava
