...
console.log(Hera_Pheri)                         // // [ "Shayam" , "Babu Rao" , "Totla Seth" , "Anuradha" , "Kaliya" ]

console.log(Hera_Pheri.shift())                 // Remove First Element
console.log(Hera_Pheri)                         // // [ "Babu Rao" , "Totla Seth" , "Anuradha" , "Kaliya" ]

console.log(Hera_Pheri.unshift("Raaju"))        // Add First Element
console.log(Hera_Pheri)                         // [ "Raaju" , "Babu Rao" , "Totla Seth" , "Anuradha" , "Kaliya" ]

let arr = [1, 2, 3, 4, 5];

console.log(arr.slice(1, 4));                   // index 1 to 3  -  [ OP : 2 , 3 , 4 ]
...
console.log(arr.lastIndexOf(4))                 // Give value from last match [ indexof - Gives First Match ]
console.log(arr)                                // [ 1 , 6 , 4 , 5 ]
...
console.log(words)                              // Doesn't modify original Array [ "Hello" , "World" ]

let arr1 = [20 , 4 , 8 , 100]

console.log(arr1.sort())           // [ 100 , 20 , 4 , 8 ] ---->  taking as string 1 [ Like A , B , C ... ( 1, 2 ..) ]
console.log(arr1.reverse())        // [ 8 , 4 , 20 , 100 ]
...
console.log("Slice , indexof , CharAt , includes , join : Doesn't modify original Arrays")
